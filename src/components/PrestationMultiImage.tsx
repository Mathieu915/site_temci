...
interface PrestationsProps {
    ...
    sousTitre: string;
    texte: string;
    images: ImageData[]; // tableau avec titre/texte/url
    position: string;
    titreModale?: string;
            ...
            <div className="container flex flex-col md:flex-row py-6 md:py-12">
                ...
                >
                    ...
                    <div className="flex flex-col justify-center gap-y-6 lg:gap-y-12">
                        ...
                        {
                            !!titreModale && <div className="mx-auto">
                                <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {images.slice(0, 4).map((image, index) => (
                            ...
                            >
                                {/* Carte */}
                                <div
                                    className="relative w-full h-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] rounded-lg shadow-md"
                                >
                                    {/* Face avant */}
                                    <div
